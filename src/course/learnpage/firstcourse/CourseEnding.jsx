  ...
  return (
    <div>
      ...
      <div className="text-white">
        ...
        <p className="text-justify">Question: <br></br>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
          Phasellus finibus ex justo, at viverra eros pellentesque in</p>
      </div>
      ...
      <div className="flex items-center justify-center space-x-4 mt-4 mb-4">
        ...
        <button type="button" className="styled border-0 leading-10 px-5 font-semibold text-base text-center text-black rounded-lg bg-[#E68369] custom-gradient custom-box-shadow hover:bg-[#ECCEAE] active:custome-active-box-shadow text-shadow w-36 h-15">End Course</button>
      </div>
    </div>
  );
};
