    ...
    <div>
      ...
      <div className="flex items-center justify-center m-10">
        <p className="text-left text-balance text-white mb-4 text-lg">
          ...
          finibus ex justo, at viverra eros pellentesque in. Praesent fermentum
          venenatis nunc, vitae rutrum tellus scelerisque at. Donec aliquam
          cursus sem, at placerat magna tristique non. Praesent aliquam
          ultricies ornare. Morbi turpis arcu, fringilla ut tortor in, lobortis
          convallis quam. Cras porta mollis tellus in rutrum. Nullam vitae
          pellentesque quam. Nullam congue ullamcorper nulla, nec tristique
          nulla bibendum suscipit.
        </p>
      </div>
